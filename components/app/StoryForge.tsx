...
import { Pen, Lock, Crown, FileText, Copy, Mail, Sparkles, MessageCircle, Users, Info } from "lucide-react";
...
ACTIVITY: [A simple, fun family activity (5-10 minutes) that practices the virtue from the story]`;
  ...
  const exportPDF = () => {
    ...
    win.document.write(`<!DOCTYPE html><html><head><title>${story.title}</title>
      ...
      ` : ""}
      <div class="footer">Virtue Forge — Building Character Through Story · virtueforge.ai</div>
    </body></html>`);
    win.document.close();
